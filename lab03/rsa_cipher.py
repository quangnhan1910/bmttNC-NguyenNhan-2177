...
class MyApp(QMainWindow):
    def __init__(self):
        ...
        # Đổi tên các nút cho đúng với giao diện của bạn nếu khác
        self.ui.btn_gen_keys.clicked.connect(self.call_api_gen_keys)
        self.ui.btn_gen_encrypt.clicked.connect(self.call_api_encrypt)
        self.ui.btn_gen_decrypt.clicked.connect(self.call_api_decrypt)
        self.ui.btn_gen_sign.clicked.connect(self.call_api_sign)
        self.ui.btn_gen_verify.clicked.connect(self.call_api_verify)
    ...
    def call_api_gen_keys(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                QMessageBox.warning(self, "Lỗi", "Error while calling API")
        except requests.exceptions.RequestException as e:
            QMessageBox.critical(self, "Lỗi", f"Error: {str(e)}")
